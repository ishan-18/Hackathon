...
function Mapp() {
    ...
    const findLocation = () => {
        ...
        const url = `http://192.168.1.60:5000/post?Lat=${lat}&Long=${lng}&date=2022-07-01&end_dt=2022-07-30`;// Replace with your desired endpoint // Replace with your desired data
